...
public class SearchYouTube {
  ...
  private static final String DEV_KEY = "AIzaSyAtqEHNE7ja29BPXH1OVrTv4XJWaAH-fug";
  ...
  private static void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query) {
    ...
    while(iteratorSearchResults.hasNext()) {
      ...
      if(rId.getKind().equals("youtube#video")) {
        ...
        System.out.println(" Embeded Video: " + embedHtml);
        System.out.println("\n-------------------------------------------------------------\n");
    ...
    public String searchVideo(String queryTerm) throws Exception 
    {
        String result = "";
        ...
        try{
            ...
            if (searchResultList != null) {
                result = prettyPrint2(searchResultList.iterator(), queryTerm);
            }
        } catch (GoogleJsonResponseException e) {
            System.err.println("There was a service error: " + e.getDetails().getCode()
                    + " : " + e.getDetails().getMessage());
    ...
    public String prettyPrint2(Iterator<SearchResult> iteratorSearchResults, String query){
    ...
    if(iteratorSearchResults.hasNext()) {
      ...
      if(rId.getKind().equals("youtube#video")) {
        ...
        videoresult = embedHtml.replaceAll("width=\'640\'", "width=\'350\'");
        videoresult = videoresult.replaceAll("height=\'360\'", "height=\'200\'");
